...
TEST(OverloadedOperators, SumMatrix) {
  auto test1 = S21Matrix(3, 3), test2 = S21Matrix(3, 3), res = S21Matrix(3, 3);
...
TEST(OverloadedOperators, SubMatrix) {
  auto test1 = S21Matrix(3, 3), test2 = S21Matrix(3, 3), res = S21Matrix(3, 3);
...
TEST(OverloadedOperators, MulNumber) {
  auto test1 = S21Matrix(3, 3), res = S21Matrix(3, 3);
  double num = 2;
...
TEST(OverloadedOperators, MulMatrix) {
  auto test1 = S21Matrix(3, 3), test2 = S21Matrix(3, 3), res = S21Matrix(3, 3);
